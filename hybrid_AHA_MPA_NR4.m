...
function [BestX, BestF, HisBestFit, VisitTable] = hybrid_AHA_MPA_NR4(MaxIt, nPop, dataset)
...
for i = 1:nPop
    PopFit(i) = objfunsdnr4_NR4(PopPos(i,:), dataset, 1, MaxIt);
end
...
for It = 1:MaxIt
    ...
    for i = 1:nPop
        ...
        newPopFit = objfunsdnr4_NR4(newPopPos, dataset, It, MaxIt);
    ...
    if mod(It, 2*nPop) == 0
        ...
        PopFit(MigrationIndex) = objfunsdnr4_NR4(PopPos(MigrationIndex,:), dataset, It, MaxIt);
        oppPopFit = objfunsdnr4_NR4(oppPopPos, dataset, It, MaxIt);
