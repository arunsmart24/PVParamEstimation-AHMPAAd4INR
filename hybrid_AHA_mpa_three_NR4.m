function [BestX,BestF,HisBestFit,VisitTable]=hybrid_AHA_mpa_three_NR4(MaxIt,nPop,dataset)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:nPop
        ...
        PopFit(i)=objfuntdnr4(PopPos(i,:), dataset, 1, MaxIt);
    end
    ...
    for It=1:MaxIt
        ...
        for i=1:nPop
            ...
            if rand<0.5   % Sine Cosine Guided foraging
                ...
                newPopFit=objfuntdnr4(newPopPos, dataset, It, MaxIt);
...
%                 newPopPos= PopPos(i,:)+randn*DirectVector(i,:).*PopPos(i,:);
        ...
        if mod(It,2*nPop)==0 % Opposition based Migration foraging
            ...
            PopFit(MigrationIndex)=objfuntdnr4(PopPos(MigrationIndex,:), dataset, It, MaxIt);
            oppPopFit=objfuntdnr4(oppPopPos,dataset,It,MaxIt);
