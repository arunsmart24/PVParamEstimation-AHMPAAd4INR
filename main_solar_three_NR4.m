...
tic
[BestX,BestF,HisBestF]=hybrid_AHA_mpa_three_NR4(MaxIteration,PopSize,dataset);
toc
...
plot(Vp,Ip,Vp,Ie,'o')   
hold off
% title('I-V characteristics of PV module with solar radiation and ambient temperature variations')
