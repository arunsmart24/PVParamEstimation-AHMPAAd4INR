function [BestX, BestF, HisBestFit, VisitTable] = hybrid_AHA_mpa_solar_NR4_partial(MaxIt, nPop,dataset)
%==========================================================================
% Hybrid AHA-MPA Algorithm for Solar PV Parameter Estimation using NR4
%
% Combines:
...
for i = 1:nPop
    PopFit(i) = objfunddnr4(PopPos(i,:), dataset, 1, MaxIt);
end
...
for It = 1:MaxIt
    ...
    for i = 1:nPop
        ...
        newPopFit = objfunddnr4(newPopPos, dataset, It, MaxIt);
